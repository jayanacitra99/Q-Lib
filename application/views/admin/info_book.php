  ...
  <div class="container-fluid row">
    ...
    <div class="card card-primary col-lg-9">
      <div class="card-header">
        <div class="row">
          <div class="col-sm-1">
            <a href="<?php echo base_url()?>Admin/viewBooks"><button class="btn btn-info"><i class="fa fa-arrow-left"></i></button></a>
          </div>
          <div class="pt-2">
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form action="<?php echo base_url()?>Admin/editBook/<?php echo $books->ID_BUKU?>" method="post">
        <div class="card-body">
    ...
    <div class="card card-primary col-lg-3">
      <div class="card-body">
        <form action="<?php echo base_url()?>Admin/editBookCover/<?php echo $books->ID_BUKU?>" method="post" enctype="multipart/form-data">
          <div class="form-group">
