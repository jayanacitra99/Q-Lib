    ...
    <header class="catalogue">
        <div class="container">
            ...
            <div class="heading mt-5 pt-5 form-inline justify-content-center">
                <h1>Form Borrowing Book</h1>
            </div>
        </div>
    </header>
    <form class="container form-book">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="date" placeholder="Enter return date">
        </div>
        
        <div class="d-flex justify-content-center align-items-center"><button type="submit" class="btn btn-primary">Submit</button>
        </div>
    </form>
    <footer class="mt-5">
        <div class="container">
